...
<head>
    ...
    <title> </title>
    <link rel="shortcut icon" href="https://s10.aconvert.com/convert/p3r68-cdx67/a5fmg-k3nhq-001.ico" type="image/x-icon">
...
<body>
    ...
    <p class="love_you"></p>
    <!-- 这里替换音乐 -->
    <audio id="music" src="loveqk.mp3" autoplay loop="false" autostart></audio>
